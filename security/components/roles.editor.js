...
let RolesEditor_1 = class RolesEditor extends index_2.CatalogEditor {
    //
...
let RolesEditor = RolesEditor_1;
RolesEditor = RolesEditor_1 = __decorate([
    core_1.Component({
        selector: 'security-rol-editor',
        templateUrl: './roles.editor.html',
        providers: [
            {
                provide: index_1.BaseComponent, useExisting: core_1.forwardRef(() => RolesEditor)
            },
            {
    ...
    __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, forms_1.FormBuilder, core_1.ChangeDetectorRef, index_1.Context, common_1.Location, rol_service_1.RolService])
], RolesEditor);
exports.RolesEditor = RolesEditor;
//# sourceMappingURL=roles.editor.js.map
...
let EnsambladosEditor_1 = class EnsambladosEditor extends index_2.CatalogEditor {
    //
...
let EnsambladosEditor = EnsambladosEditor_1;
EnsambladosEditor = EnsambladosEditor_1 = __decorate([
    core_1.Component({
        selector: 'custom-ensamblados-editor',
        templateUrl: './ensamblados.editor.html',
        providers: [
            {
                provide: index_1.BaseComponent, useExisting: core_1.forwardRef(() => EnsambladosEditor)
            },
            {
    ...
    __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, forms_1.FormBuilder, core_1.ChangeDetectorRef, index_1.Context, common_1.Location, ensamblado_service_1.EnsambladoService])
], EnsambladosEditor);
exports.EnsambladosEditor = EnsambladosEditor;
//# sourceMappingURL=ensamblados.editor.js.map
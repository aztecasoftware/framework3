...
class HierarchyManager {
    ...
    ngOnInit() {
        if (!this.nodeForm)
            return;
        this.nodeForm.statusChanges.subscribe(() => {
    ...
    showEditor() {
        this.manager.showEditor();
    }
    hideEditor() {
        this.manager.hideEditor();
    }
    addNode(info, parentNode) {
        this.manager.addNode(info, parentNode);
    }
    updateNode(info) {
        this.manager.updateNode(info);
    }
    deleteNode(node) {
    ...
    handleError(error) {
        ...
        this.showAlert(this.errorMessage, 'danger');
    }
}
__decorate([
    core_1.Input(),
...
__decorate([
    core_1.Input(),
    __metadata("design:type", Boolean)
], HierarchyManager.prototype, "autogeneratedCode", void 0);
__decorate([

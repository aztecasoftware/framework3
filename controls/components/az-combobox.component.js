...
let AzComboboxComponent_1 = class AzComboboxComponent extends base_control_1.BaseControl {
    constructor() {
        super(...arguments);
        this.items = [];
        this.displayMember = '';
...
let AzComboboxComponent = AzComboboxComponent_1;
__decorate([
    core_1.Input(), 
...
AzComboboxComponent = AzComboboxComponent_1 = __decorate([
    core_1.Component({
        ...
        providers: [
            {
                provide: base_component_1.BaseComponent, useExisting: core_1.forwardRef(() => AzComboboxComponent)
            },
            {
                provide: forms_1.NG_VALUE_ACCESSOR, useExisting: core_1.forwardRef(() => AzComboboxComponent), multi: true
            }
        ]
    }), 

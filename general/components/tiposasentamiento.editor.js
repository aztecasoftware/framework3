...
let TiposAsentamientoEditor = TiposAsentamientoEditor_1 = class TiposAsentamientoEditor extends index_2.CatalogEditor {
    //
    constructor(router, route, formBuilder, changeDetector, context, location, tipoAsentamientoService) {
        ...
        this.tipoasentamiento = new tipoasentamiento_1.TipoAsentamientoInfo();
    ...
    onViewingItem(id) {
        ...
        this.tipoAsentamientoService.getDetailByID(id)
            .then(info => {
            this.context.app.hideSpinner();
            this.tipoasentamiento = info;
    ...
    onCloningItem(id) {
        this.context.app.showSpinner();
        //
        this.tipoAsentamientoService.clone(id)
            .then(info => {
            this.context.app.hideSpinner();
            this.tipoasentamiento = info;
        })
    ...
    onSavingItem(args) {
        this.context.app.showSpinner();
        this.tipoAsentamientoService.update(this.tipoasentamiento)
            .then(info => {
            this.context.app.hideSpinner();
            this.tipoasentamiento = info;
            if (args.closeEditor)
...
TiposAsentamientoEditor = TiposAsentamientoEditor_1 = __decorate([
    core_1.Component({
        selector: 'general-tiposasentamiento-editor',
        template: `
      <form [formGroup]="catalogForm">

          <azteca-catalog-editor #catalogEditor 
                                 [title]="'TipoAsentamiento'"
                                 [info]="tipoasentamiento"
              ...
              <div class="row">
                  <div class="col-xs-10 col-md-10">
                      <azteca-form-field [label]="'Código:'">
                          <catalog-code formControlName="codigo" [(ngModel)]="tipoasentamiento.code" [automatic]="autogeneratedCode"></catalog-code>
                      </azteca-form-field>

                      <azteca-form-field [label]="'Nombre:'">
                          <az-textbox formControlName="nombre" [(ngModel)]="tipoasentamiento.nombre"></az-textbox>
                      </azteca-form-field>
    ...
    `,
        providers: [
            {
                provide: index_1.BaseComponent, useExisting: core_1.forwardRef(() => TiposAsentamientoEditor_1)
            },
            {
    ...
    __metadata("design:paramtypes", [router_1.Router, router_1.ActivatedRoute, forms_1.FormBuilder, core_1.ChangeDetectorRef,
        index_1.Context, common_1.Location, tipoasentamiento_service_1.TipoAsentamientoService])
], TiposAsentamientoEditor);
exports.TiposAsentamientoEditor = TiposAsentamientoEditor;
var TiposAsentamientoEditor_1;
